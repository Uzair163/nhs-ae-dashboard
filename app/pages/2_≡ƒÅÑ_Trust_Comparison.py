...
n_flagged = int(df["suspect_zero_breach_flag"].sum())
n_flagged_trusts = df[df["suspect_zero_breach_flag"]]["org_code"].nunique()
...
with col1:
    ...
    st.caption("20 lowest-performing Trusts, 2025-26 (flag-excluded)")
    st.bar_chart(bottom_20, height=500)
