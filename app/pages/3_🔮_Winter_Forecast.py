...
st.caption(
    "This forecast has no Region/Trust filter, unlike the other pages — the forecast model "
    "only ever produces a single national figure per month, it doesn't break down by Trust."
)
...
st.line_chart(chart_df, height=350, color=[theme.NHS_BLUE])
